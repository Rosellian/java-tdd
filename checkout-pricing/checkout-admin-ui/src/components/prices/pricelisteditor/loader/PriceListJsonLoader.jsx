...
import {exportPriceList, importPriceList} from "./ops";

export function PriceListJsonLoader({ priceList, onImport }) {
        ...
        <div style={styles.container}>
            <div style={{
                ...
                ...(hover === "export" ? hoverStyle : {})
                 ...
                 onClick={() => exportPriceList(priceList)}
            >
                Export JSON
            </div>
            ...
            <div style={{
                ...
                ...(hover === "import" ? hoverStyle : {})
                 ...
                 onMouseLeave={() => setHover(null)}
                 onClick={() => importPriceList(onImport)}
            >
                Import JSON
            </div>
        </div>
